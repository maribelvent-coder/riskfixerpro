...
const controls: ControlData[] = [
  ...
  // Training & Awareness
  {
    ...
    controlType: "Preventive",
    description: "Regular training for employees on security policies, tailgating prevention, and incident reporting",
    baseWeight: 3,
    reductionPercentage: 45,
    implementationNotes: "Conduct annually at minimum, include scenarios and case studies, track completion",
    estimatedCost: "$20-$50 per employee annually",
    maintenanceLevel: "Medium",
    trainingRequired: false,
    maintenanceRequired: false
  },
  {
    name: "Active Threat Response Training",
    category: "Training & Awareness",
    controlType: "Preventive",
    description: "Run-Hide-Fight or ALICE training for active shooter situations",
    baseWeight: 4,
    reductionPercentage: 60,
    implementationNotes: "Conduct annually, include evacuation drills, coordinate with local law enforcement",
    estimatedCost: "$1,000-$5,000 per session",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    ...
    category: "Cyber-Physical Security",
    controlType: "Preventive",
    description: "Two or more authentication factors required for system access",
    baseWeight: 4,
    reductionPercentage: 75,
    implementationNotes: "Combine card + PIN, biometric + card, or mobile push notifications",
    estimatedCost: "Varies by system",
    maintenanceLevel: "Low",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    name: "Security System Patch Management",
    category: "Cyber-Physical Security",
    controlType: "Preventive",
    description: "Regular updates and patches for security system firmware and software",
    baseWeight: 3,
    reductionPercentage: 55,
    implementationNotes: "Test patches in non-production first, maintain backup configurations, schedule quarterly",
    estimatedCost: "Staff time",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    name: "Access Control Policy & Audit",
    category: "Procedural Controls",
    controlType: "Detective",
    description: "Regular audits of access rights and removal of inactive credentials",
    baseWeight: 3,
    reductionPercentage: 50,
    implementationNotes: "Quarterly audits, automated deprovisioning on termination, document exceptions",
    estimatedCost: "Staff time",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    ...
    category: "Procedural Controls",
    controlType: "Preventive",
    description: "Requirement that sensitive documents be secured when unattended",
    baseWeight: 2,
    reductionPercentage: 35,
    implementationNotes: "Provide lockable drawers/cabinets, enable auto screen locks, conduct spot checks",
    estimatedCost: "Negligible",
    maintenanceLevel: "Low",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    ...
    category: "Access Control",
    controlType: "Preventive",
    description: "Optical turnstiles or speed gates with anti-tailgating sensors",
    baseWeight: 4,
    reductionPercentage: 80,
    implementationNotes: "Integrate with badge system, include alarm on tailgating attempt, ADA-compliant lane required",
    estimatedCost: "$8,000-$25,000 per lane",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: true
  },
  {
    name: "CCTV System - Outdoor",
    category: "Surveillance",
    controlType: "Detective",
    description: "Weather-resistant IP cameras for perimeter and parking lot surveillance",
    baseWeight: 4,
    reductionPercentage: 65,
    implementationNotes: "Use IK10-rated housings, infrared for night vision, PoE for power",
    estimatedCost: "$1,000-$3,000 per camera installed",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: true
  },
  {
    ...
    category: "Environmental Design",
    controlType: "Deterrent",
    description: "Warning signs about surveillance, security measures, and restricted areas",
    baseWeight: 1,
    reductionPercentage: 15,
    implementationNotes: "Post at perimeter, entrances, and parking areas. Clear, visible signage",
    estimatedCost: "$10-$50 per sign",
    maintenanceLevel: "Low",
    trainingRequired: false,
    maintenanceRequired: false
  },
  {
    name: "CPTED Principles - Clear Zones",
    category: "Environmental Design",
    controlType: "Deterrent",
    description: "Crime Prevention Through Environmental Design - maintaining clear zones around buildings",
    baseWeight: 2,
    reductionPercentage: 30,
    implementationNotes: "15-25 foot clear zones, vegetation below 3 feet, remove concealment opportunities",
  ...
  {
    name: "Perimeter Fencing - Anti-Climb",
    category: "Physical Barriers",
    controlType: "Deterrent",
    description: "High-security fencing with anti-climb features (8+ ft, small mesh, top guard)",
    baseWeight: 3,
    reductionPercentage: 55,
    implementationNotes: "8-10 feet high, anti-climb mesh or design, outriggers with barbed/razor wire where permitted",
    estimatedCost: "$25-$60 per linear foot",
    maintenanceLevel: "Low",
    trainingRequired: false,
    maintenanceRequired: true
  },
  ...
  // Executive Protection
  {
    ...
    baseWeight: 5,
    reductionPercentage: 85,
    implementationNotes: "Requires highly trained personnel, advance planning, threat intelligence integration, and coordination protocols",
    estimatedCost: "$250,000-$500,000 annually per executive",
    maintenanceLevel: "High",
    trainingRequired: true,
    maintenanceRequired: true
  },
  {
    ...
    baseWeight: 3,
    reductionPercentage: 60,
    implementationNotes: "Drivers must complete defensive driving and security awareness training, background checks required",
    estimatedCost: "$60,000-$120,000 annually",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    ...
    baseWeight: 4,
    reductionPercentage: 75,
    implementationNotes: "Requires proper maintenance, driver training on handling characteristics, periodic armor inspection",
    estimatedCost: "$75,000-$300,000 per vehicle",
    maintenanceLevel: "High",
    trainingRequired: true,
    maintenanceRequired: true
  },
  {
    ...
    baseWeight: 2,
    reductionPercentage: 45,
    implementationNotes: "Establish multiple routes, vary departure times, coordinate with security team, document procedures",
    estimatedCost: "$5,000-$15,000 for planning and coordination",
    maintenanceLevel: "Low",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    ...
    baseWeight: 4,
    reductionPercentage: 75,
    implementationNotes: "24/7 coverage, trained personnel, coordination with local law enforcement, emergency response protocols",
  ...
  },
  {
    ...
    baseWeight: 4,
    reductionPercentage: 70,
    implementationNotes: "Install during construction or major renovation, include independent power, communications, ventilation, and emergency supplies",
    estimatedCost: "$50,000-$200,000",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: true
  },
  {
    ...
    baseWeight: 3,
    reductionPercentage: 65,
    implementationNotes: "Contract with professional monitoring center, ensure redundant communications, regular camera maintenance",
    estimatedCost: "$10,000-$50,000 installation + $5,000-$20,000 annually",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: true
  },
  {
    ...
    baseWeight: 3,
    reductionPercentage: 55,
    implementationNotes: "Contract with threat intelligence provider, regular briefings, integration with security protocols",
    estimatedCost: "$25,000-$100,000 annually",
    maintenanceLevel: "Medium",
    trainingRequired: true,
    maintenanceRequired: false
  },
  {
    ...
    baseWeight: 2,
    reductionPercentage: 40,
    implementationNotes: "Ongoing service to monitor and remove PII from data brokers, public records, social media",
    estimatedCost: "$5,000-$25,000 annually",
    maintenanceLevel: "Low",
    trainingRequired: false,
    maintenanceRequired: false
  },
  {
    ...
    baseWeight: 2,
    reductionPercentage: 45,
    implementationNotes: "Annual training, age-appropriate content, includes situational awareness, emergency protocols, social media safety",
  ...
  },
  {
    ...
    baseWeight: 2,
    reductionPercentage: 50,
    implementationNotes: "Subscription service, integration with security operations center, family member access, regular testing",
    estimatedCost: "$10,000-$30,000 annually",
    maintenanceLevel: "Low",
    trainingRequired: true,
    maintenanceRequired: false
  },
