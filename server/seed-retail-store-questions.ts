...
const CONTROL_NAME_MAP: Record<string, string> = {
  ...
  'closing_procedures_two_person': 'Access Authorization Process',
  'dressing_room_attendant': 'Security Officer - Unarmed',
  ...
  'employee_package_inspection': 'Physical Search Policy',
  ...
  'loss_prevention_plain_clothes': 'Security Officer - Unarmed',
  'loss_prevention_uniformed': 'Security Officer - Uniformed',
  ...
  'security_officer_daytime': 'Security Officer - Uniformed',
