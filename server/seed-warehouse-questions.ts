...
const CONTROL_NAME_MAP: Record<string, string> = {
  'alarm_response_procedures': 'Security Procedure',
  ...
  'dock_door_sensors_open_close': 'Door Contact Sensors',
  'dock_intrusion_alarm': 'Intrusion Detection System',
  'dock_leveler_locks': 'Perimeter Fencing - Chain Link',
  'dock_procedure_documentation': 'Security Procedure',
  ...
  'fuel_theft_prevention': 'Asset Tracking',
  'gate_access_control_with_guard': 'Security Officer - Uniformed',
  'gps_tracking_fleet_vehicles': 'GPS Tracking',
  'high_security_fencing_8ft': 'Perimeter Fencing - Anti-Climb',
  'high_value_inventory_caging': 'Physical Barrier',
  'insider_threat_program': 'Background Checks',
  'interior_caging_high_value': 'Physical Barrier',
  'key_control_system': 'Key Management System',
  'kingpin_locks_parked_trailers': 'Physical Barrier',
  'loading_dock_cctv_all_doors': 'CCTV System - IP/Network',
  'load_verification_procedures': 'Inventory Audit & Shrink Analysis',
  'lot_serial_tracking': 'Asset Tracking',
  'perimeter_intrusion_detection': 'Perimeter Intrusion Detection',
  ...
  'shipping_receiving_procedures': 'Security Procedure',
  'theft_reporting_hotline': 'Anonymous Reporting Hotline',
  'trailer_parking_designated_area': 'Parking Management',
  ...
  'vehicle_immobilization_system': 'GPS Tracking',
  ...
  'warehouse_management_system': 'Asset Tracking'
};
